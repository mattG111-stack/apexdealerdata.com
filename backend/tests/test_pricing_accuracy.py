...
# Measured 2026-08-31 on week 2026-07-25, with self-matching excluded:
# median 7.6%, p90 26.9%, 87% priced. (An earlier 4.7% was fiction — each car's
# own prior-week listing was left in its comp pool, so the engine was partly
# pricing cars off themselves.)
MAX_MEDIAN_ERROR_PCT = 9.5
