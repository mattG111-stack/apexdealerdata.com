...
def briefing_text(name: str | None, dealer_name: str | None,
    ...
    if not opportunities:
        return (f"{head}\n\nOnce a couple of weekly files are in I'll open every "
                "morning with the plays — what to buy, what to exit, where the "
                "margin's hiding. Ask me anything in the meantime.")
