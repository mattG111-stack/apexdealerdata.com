...
A dealer principal has no reason to own a Claude key, and would treat being
asked for one as a reason not to sign up. So Apex keeps one platform key per
service, set in the admin dashboard.
