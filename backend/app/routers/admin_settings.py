...
def test_setting(
    ...
    if name == secrets_store.CARJAM_API_KEY:
        # Wired up with the CarJam client; until then, saying "not implemented"
        # is honest where returning ok=True would be a lie.
        return TestResult(ok=False, detail="CarJam test not wired up yet.")
